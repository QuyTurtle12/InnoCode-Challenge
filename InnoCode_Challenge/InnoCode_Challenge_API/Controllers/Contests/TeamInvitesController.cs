...
namespace InnoCode_Challenge_API.Controllers
{
    ...
    public class TeamInvitesController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize(Policy = "RequireStaffOrAdmin")] // mentors can also view their team invites via EnsureTeamAccess
        public async Task<IActionResult> List(Guid teamId, [FromQuery] TeamInviteQueryParams query)
        {
            ...
            return Ok(new BaseResponseModel<object>(StatusCodes.Status200OK, ResponseCodeConstants.SUCCESS, page.Items, meta, "Invites retrieved."));
        }

        [HttpPost]
        [Authorize] // mentor of the team, or staff/admin
        public async Task<IActionResult> Create(Guid teamId, [FromBody] CreateTeamInviteDTO dto)
        {
            ...
            return CreatedAtAction(nameof(List), new { teamId }, new BaseResponseModel<object>(
                StatusCodes.Status201Created, ResponseCodeConstants.SUCCESS, created, message: "Invite created."));
        }
