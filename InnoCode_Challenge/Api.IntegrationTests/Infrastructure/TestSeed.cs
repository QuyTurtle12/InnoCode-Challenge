...
namespace Api.IntegrationTests.Infrastructure
{
    public static class TestSeed
    {
        ...
        public static readonly Guid DefaultProvinceId = Guid.Parse("2ef61ca0-ed88-4a43-b842-7c0d059e3506");
        ...
        public static string SchoolManagerEmail { get; private set; } = "schoolmanager@test.com";
        public static string SchoolManagerPassword { get; private set; } = "P@ssword123!";
        ...
        public static void Seed(ContestDbContext db)
        {
            ...
            if (!db.Provinces.Any(p => p.ProvinceId == DefaultProvinceId))
            {
            ...
            if (!db.Users.Any(u => u.Email == SchoolManagerEmail.ToLower() && u.DeletedAt == null))
            {
                db.Users.Add(new User
                {
                    ...
                    Email = SchoolManagerEmail.Trim().ToLowerInvariant(),
                    PasswordHash = PasswordHasher.Hash(SchoolManagerPassword),
